...
import { validateAnthropicMessagesRequest, mapAnthropicMessagesRequestToAISDKInput } from './protocol.js'
...
import type { AnthropicSSEData } from './types.js'

export const anthropicStrategy: ProtocolStrategy<AnthropicMessagesRequest, AnthropicSSEData> = {
