...
function extractRaw(chunk: unknown): string | undefined {
  ...
  if (chunk && typeof chunk === 'object' && 'rawValue' in chunk && typeof chunk.rawValue === 'string') {
...
function extractError(value: unknown): Record<string, unknown> | undefined {
  ...
  return value.error && typeof value.error === 'object' ? (value.error as Record<string, unknown>) : undefined;
}
